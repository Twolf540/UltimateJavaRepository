...
public class RandomStats {
    public static void main(String[] args) {
        ...
        double maximum1 = Math.min(value1, value2);
        double maximum2 = Math.min(value2, value3);
        double maximum3 = Math.min(value3, value4);
        double maximum4 = Math.min(value4, value5);
        double maximum5 = Math.min(value5, value1);
        //lowers the possible highestvalues values down to two
        double maximum6 = Math.min(maximum1, maximum2);
        double maximum7 = Math.min(maximum3, maximum4);
        double maximum8 = Math.min(maximum7, maximum5);
